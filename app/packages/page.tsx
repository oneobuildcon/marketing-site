...
const categories = [
  { id: "designs", name: "Designs & Layouts", icon: PencilRuler },
  { id: "earthwork", name: "Earth Work", icon: Shovel },
  { id: "structure", name: "Structure", icon: Building2 },
  { id: "flooring", name: "Flooring", icon: Layers },
  { id: "kitchen", name: "Kitchen Counter", icon: UtensilsCrossed },
  { id: "bathroom", name: "Bathroom", icon: Bath },
  { id: "doors", name: "Door Frames & Fitting", icon: DoorOpen },
  { id: "window", name: "Window", icon: Square },
  { id: "plumbing", name: "Plumbing & Sanitation", icon: Droplets },
  { id: "electrical", name: "Electrical", icon: Zap },
];

type PackageId = "structure" | "basic" | "standard" | "premium" | "royal" | "luxury";
type CategoryId = "designs" | "earthwork" | "structure" | "flooring" | "kitchen" | "bathroom" | "doors" | "window" | "plumbing" | "electrical";

const packageData: Record<PackageId, Record<CategoryId, string[]>> = {
  structure: {
...
export default function Packages() {
  ...
  const items = packageData[selectedPkg][selectedCat];
  const pkgInfo = packages.find((p) => p.id === selectedPkg)!;
