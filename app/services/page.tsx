...
const translations = {
  en: {
    ...
    services: [
      { title: "Premium Bungalows", desc: "Custom-designed bungalows with premium finishes, built to your exact specifications from foundation to final touches.", img: "/services/bungalow.png" },
      { title: "Row Houses", desc: "Thoughtfully planned row house developments that balance privacy, community, and efficient land use.", img: "/services/rowhouse.png" },
      { title: "Residential Buildings", desc: "Multi-storey residential complexes engineered for safety, durability, and comfortable modern living.", img: "/services/residential.png" },
      { title: "Farmhouses", desc: "Farmhouse builds designed to blend with natural surroundings while offering modern comfort and durability.", img: "/services/farmhouse.png" },
      { title: "RCC Work", desc: "Precision RCC structural work — foundations, columns, slabs, and framing carried out to strict engineering standards.", img: "/services/rcc.png" },
      { title: "Interior Finishing", desc: "Floor-to-ceiling interior finishing — flooring, fittings, paint, and décor tailored to your taste.", img: "/services/interior.png" },
    ],
  ...
  mr: {
    ...
    services: [
      { title: "प्रीमियम बंगले", desc: "उत्तम फिनिशिंगसह कस्टम-डिझाइन केलेले बंगले, पायापासून अंतिम स्पर्शापर्यंत तुमच्या अचूक वैशिष्ट्यांनुसार बांधले.", img: "/services/bungalow.png" },
      { title: "रो हाउस", desc: "गोपनीयता, समुदाय आणि कार्यक्षम जमीन वापर संतुलित करणारे विचारपूर्वक नियोजित रो हाउस विकास.", img: "/services/rowhouse.png" },
      { title: "निवासी इमारती", desc: "सुरक्षितता, टिकाऊपणा आणि आरामदायक आधुनिक जीवनासाठी अभियांत्रिकी केलेले बहुमजली निवासी संकुले.", img: "/services/residential.png" },
      { title: "फार्महाउस", desc: "नैसर्गिक परिसराशी मेळ घालणारे आणि आधुनिक आराम व टिकाऊपणा देणारे फार्महाउस बांधकाम.", img: "/services/farmhouse.png" },
      { title: "आरसीसी काम", desc: "अचूक आरसीसी संरचनात्मक काम — कठोर अभियांत्रिकी मानकांनुसार पाया, खांब, स्लॅब आणि फ्रेमिंग.", img: "/services/rcc.png" },
      { title: "इंटेरियर फिनिशिंग", desc: "मजल्यापासून छतापर्यंत इंटेरियर फिनिशिंग — तुमच्या अभिरुचीनुसार फ्लोरिंग, फिटिंग्ज, रंग आणि सजावट.", img: "/services/interior.png" },
    ],
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-52 w-full overflow-hidden">
                    ...
                    <Image src="/services/cover.png" alt="" fill className="object-cover opacity-30" />
                    <div className="absolute inset-0 bg-gradient-to-br from-navy via-navy/90 to-navy/70" />
                    {/* Service illustration on top */}
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative w-44 h-44 [filter:drop-shadow(0_8px_16px_rgba(0,0,0,0.5))]">
                        <Image src={service.img} alt={service.title} fill className="object-contain transition-transform duration-700 group-hover:scale-110" />
                      </div>
                    </div>
