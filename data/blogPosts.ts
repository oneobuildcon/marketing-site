...
export type BlogPost = {
  ...
  // Marathi version, served at /mr/blog/<slug> with hreflang linking the two.
  // Optional — a post without it simply has no Marathi page.
  mr?: {
    title: string;
    summary: string;
    body: string;
...
export const defaultBlogPosts: BlogPost[] = [
  {
    ...
    mr: {
      title: "पुण्यात घर बांधकाम खर्च प्रति स्क्वेअर फूट — २०२६ चे दर",
      summary:
        "पुणे आणि पिंपरी-चिंचवडमध्ये २०२६ मध्ये टर्नकी बांधकामाचा दर रु. १,४९९ ते रु. २,०९९ प्रति स्क्वेअर फूट आहे, तर फक्त आरसीसी व विटकामासाठी रु. ८७० प्रति स्क्वेअर फूट. या आकड्यांमागे काय आहे, बिल्ट-अप क्षेत्र कसे मोजले जाते आणि तीन प्रत्यक्ष प्रकल्पांची उदाहरणे.",
      body: `प्रत्येक संभाषणाची सुरुवात एकाच प्रश्नाने होते: "तुमचा दर प्रति स्क्वेअर फूट किती?" थोडक्यात उत्तर — पुणे आणि परिसरात २०२६ मध्ये **टर्नकी बांधकामासाठी रु. १,४९९ ते रु. २,०९९ प्रति स्क्वेअर फूट**, आणि **फक्त आरसीसी व विटकाम हवे असल्यास रु. ८७० प्रति स्क्वेअर फूट**. हा फरक फिनिशिंगमुळे येतो, संरचनेमुळे नाही — काँक्रीट आणि स्टील दोन्ही टोकांना जवळपास सारखेच असते.

पण सविस्तर उत्तर अधिक महत्त्वाचे आहे, कारण फक्त दर पाहून घराची किंमत कळत नाही.

## आमचे २०२६ चे दर

| पॅकेज | दर प्रति स्क्वेअर फूट |
| --- | --- |
| फक्त आरसीसी व विटकाम | रु. ८७० |
| बेसिक टर्नकी | रु. १,४९९ |
| स्टँडर्ड टर्नकी | रु. १,६४९ |
| प्रीमियम टर्नकी | रु. १,९४९ |
| रॉयल टर्नकी | रु. २,०९९ |

सर्व दर बिल्ट-अप क्षेत्रावर आहेत. **मूळ रकमेवर १८% जीएसटी अतिरिक्त.**

## रु. ८७० आणि रु. १,६४९ मधील फरक काय?

रु. ८७० च्या दरात संरचना येते — फूटिंग, कॉलम, बीम, स्लॅब, विटकाम आणि प्लास्टर. तुम्हाला पूर्ण सांगाडा मिळतो. त्यानंतरचे सर्व — फ्लोअरिंग, ग्रॅनाइट, प्लंबिंग फिटिंग, वायरिंग, दरवाजे, खिडक्या, रंगकाम — तुम्हाला स्वतः करावे लागते.

टर्नकी दरात तीच संरचना आणि सर्व फिनिशिंग काम येते, आणि संपूर्ण घरासाठी एकच कंत्राटदार जबाबदार असतो.

म्हणजे **टर्नकी दराचा साधारण अर्धा भाग संरचना आणि अर्धा फिनिशिंग** असतो.

## बिल्ट-अप क्षेत्र म्हणजे फ्लोअर एरिया नव्हे

हा मुद्दा बहुतेकांना चुकतो, आणि दरापेक्षा तो एकूण रकमेवर जास्त परिणाम करतो.

घराचे बिल भरताना कार्पेट एरिया धरले जात नाही. बिल्ट-अप क्षेत्र असे मोजले जाते:

- **प्लिंथ** — ग्राउंड स्लॅबच्या साधारण ५०%
- **ग्राउंड फ्लोअर** — राहण्याची जागा असल्यास १००%, पार्किंग असल्यास ५०%
- **वरचे मजले** — प्रत्येकी १००%
- **टेरेस** — वरच्या स्लॅबच्या साधारण ३५%

म्हणून १,००० स्क्वेअर फूट जागेवर दोन मजले बांधल्यास बिल २,००० स्क्वेअर फूटचे होत नाही. प्लिंथ ५०० आणि टेरेस ३५० धरल्यास ते जवळपास २,८५० स्क्वेअर फूट होते.

रु. १,६४९ दराने हा फरक रु. ३३ लाख आणि रु. ४७ लाख यामधला आहे — तेच घर, तोच दर.

कोणत्याही कंत्राटदाराकडून हे गणित लेखी मागा.

## तीन प्रत्यक्ष प्रकल्प

**चारोली, पुणे — ३,३३० स्क्वेअर फूट, २०२३ मध्ये पूर्ण.** डबल-हाइट लिव्हिंग रूम, ग्लास बाल्कनी रेलिंग आणि टेराकोटा फसाड. स्टँडर्ड दराने साधारण **रु. ५४.९ लाख** (जीएसटी वगळून).

**चारोली, पुणे — ५,५६५ स्क्वेअर फूट, २०२५ मध्ये पूर्ण.** एक्सपोज्ड ब्रिक, लाकडी लुव्हर्स, खुल्या बाल्कन्या. स्टँडर्ड दराने साधारण **रु. ९१.८ लाख**.

**लोहगाव, पुणे — ५,७०० स्क्वेअर फूट, बांधकाम सुरू.** प्रीमियम दराने साधारण **रु. १.११ कोटी**.

हे आकडे त्या दरांवरील गणित आहे. प्रत्यक्ष करार रक्कम निवडलेले पॅकेज आणि बांधकामादरम्यानच्या निवडींवर अवलंबून असते.

## दरात काय समाविष्ट नाही

- कंपाउंड वॉल आणि गेट
- पार्किंगशेजारील लँडस्केपिंग
- बाह्य फसाड डिटेलिंग आणि मोल्डिंग
- आरसीसी ओव्हरहेड पाण्याची टाकी
- बोअरवेल, वीज मीटर, पाणी कनेक्शन
- फर्निचर आणि इंटिरियर

हे वगळणे अवाजवी नाही. अडचण फक्त तेव्हा येते जेव्हा ते लेखी नसते.

## एक कंत्राटदार रु. १,५०० आणि दुसरा रु. २,१०० का सांगतो?

कारण ते दोन वेगळी घरे सांगत असतात. तीन गोष्टी तपासा:

1. **बिल्ट-अप क्षेत्र कसे मोजले** — एकाने टेरेस ५०% धरले आणि दुसऱ्याने ३५%, तर दोन्ही दर तुलनायोग्यच नाहीत.
2. **विचारात घेतलेले मटेरियल दर** — टाइलसाठी रु. ३५ आणि रु. १०० हे एकाच दरात दोन वेगळी घरे आहेत.
3. **नमूद केलेले ब्रँड** — स्टील, सिमेंट, वॉटरप्रूफिंग, वायरिंग, पाइप आणि सीपी फिटिंग.

## आम्ही काय लेखी देतो

आमच्या प्रत्येक कोटेशनमध्ये मजल्यानुसार बिल्ट-अप क्षेत्राचे गणित, प्रत्येक कामाचे स्पेसिफिकेशन, मटेरियल दर, वापरलेले ब्रँड, टप्प्यानुसार पेमेंट शेड्यूल आणि वगळलेल्या बाबी असतात.

तुमच्याकडे प्लॉट आणि ड्रॉइंग असेल तर आम्ही तुमच्या प्रकल्पासाठी कोटेशन तयार करून देऊ.`,
      faqs: [
        { q: "पुण्यात २०२६ मध्ये बांधकाम खर्च प्रति स्क्वेअर फूट किती आहे?", a: "फिनिशिंग स्पेसिफिकेशननुसार टर्नकी बांधकाम रु. १,४९९ ते रु. २,०९९ प्रति स्क्वेअर फूट. फक्त आरसीसी व विटकाम साधारण रु. ८७० प्रति स्क्वेअर फूट. मूळ रकमेवर १८% जीएसटी अतिरिक्त." },
        { q: "दर कार्पेट एरियावर की बिल्ट-अप एरियावर लागू होतो?", a: "बिल्ट-अप एरियावर. प्लिंथ ग्राउंड स्लॅबच्या ५०%, वरचे मजले प्रत्येकी १००% आणि टेरेस वरच्या स्लॅबच्या ३५% धरले जाते. १,००० स्क्वेअर फूट जागेवर दोन मजल्यांचे बिल जवळपास २,८५० स्क्वेअर फूट होते." },
        { q: "२,००० स्क्वेअर फूट घर बांधण्यासाठी किती खर्च येतो?", a: "स्टँडर्ड दर रु. १,६४९ प्रमाणे २,००० स्क्वेअर फूट बिल्ट-अप क्षेत्रासाठी साधारण रु. ३३ लाख, जीएसटी वगळून." },
        { q: "कोटेशनमध्ये सामान्यतः काय समाविष्ट नसते?", a: "कंपाउंड वॉल आणि गेट, लँडस्केपिंग, बाह्य फसाड डिटेलिंग, ओव्हरहेड पाण्याची टाकी, बोअरवेल, वीज मीटर, पाणी कनेक्शन आणि फर्निचर व इंटिरियर." },
      ],
    },
