...
// (1450 sheet → Basic, 1650 sheet → Standard), with rates kept in step with the
// website Packages page. Everything here is only the DEFAULT — the admin can
// edit every line before generating a PDF.
...
const basePresets: QuotationPreset[] = [
  {
    ...
    rates: [
      ...
      { work: "Plumbing", items: ["P-trap / S-trap commode (Rs. 4,000)", "Flush tank (Rs. 2,000)", "Mixer (Rs. 4,000)", "Wash basin (Rs. 2,000)", "Indian commode (Rs. 2,000)", "2000 litre water tank (Plasto)"] },
  ...
  },
  {
    ...
    rates: [
      ...
      { work: "Brick", items: ["Rs. 14 / piece"] },
      { work: "Plumbing", items: ["Wall hanging commode (Rs. 8,000)", "Flush valve (Rs. 6,000)", "Diverter (Rs. 6,000)", "Wash basin (Rs. 2,500)", "Indian commode (Rs. 2,000)", "2000 litre water tank (Plasto)"] },
      { work: "Grill", items: ["Rs. 150 / sq.ft"] },
  ...
  },
  {
    ...
    payments: [
      ...
      { stage: "After 4th RCC Slab", percent: "10" },
      { stage: "At Start of Brickwork", percent: "10" },
      { stage: "After Brickwork (2 Floors)", percent: "10" },
      { stage: "Before Outer Plaster", percent: "5" },
      { stage: "At Start of Inside Plaster", percent: "5" },
      { stage: "On Handover / Possession", percent: "5" },
    ],
    notes: [{ title: "", items: [
      "Electricity, water, borewell and electric meter are in the client's scope, along with water tankers and space to store water until the underground tank is ready.",
      "External facade work such as mouldings is not included; standard plaster is considered. Any external detailing is charged extra.",
      "Landscaping of the outer area beside the parking is not included.",
      "Compound wall and gate are not included.",
      "Curing of the project is in the client's scope, along with a store room on site for material and labour.",
      "An RCC overhead water tank, if required, is charged extra.",
      "GST 18% extra on the base amount.",
      "Minor cracks may appear in walls due to heat of hydration — this is normal and causes no harm to the structure.",
      "Any work not listed in this quotation is charged extra.",
      "This quotation is valid for 15 days.",
      "If excavation and back-filling are done by the client, the plinth rate is considered as 75% of the slab area.",
      "Manual concreting is considered. If RMC is required, the extra cost is added.",
      "Any dispute with a neighbour or the corporation is to be resolved by the client.",
      "In case of natural disaster, pandemic or war, the project timeline extends accordingly.",
    ]}],
  },
];
