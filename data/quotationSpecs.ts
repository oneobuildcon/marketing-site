...
export const defaultSpecialNotes: string[] = [
  ...
  "External facade such as mouldings is not considered in this quote; normal typical plaster is considered. Any external detailing shall be charged extra.",
  "Landscaping of the outer area beside the parking area is not considered.",
  ...
  "Excavation and back-filling are not considered and will be in the client's scope.",
  "GST extra on base amount (18%).",
  "Tiles have a minor natural bend, so there may be a slight difference in level — this is normal.",
  "Minor cracks may appear in walls due to heat of hydration — this is normal and causes no harm to the structure.",
  "Any work other than mentioned in the above quotation will be charged extra.",
  "Quotation is valid up to 15 days.",
  "In case of any natural disaster (like pandemic) or war, the project timeline will increase.",
  "In bathrooms or balconies, where the area is small, some water may stay — this is normal.",
...
export const quotationPresets: QuotationPreset[] = [
  {
    ...
    sections: [
      { title: "RCC DETAILS", items: [
        "Work done as per architect drawing. Plate shuttering for slab. Steel: Uma / Kalika or equivalent. Cement: Birla Super 53 Grade.",
      ]},
      { title: "BRICKWORK, PLASTER & WATERPROOFING DETAILS", items: [
        'Brick work as per architect drawing, using red brick. All walls 6" brick work.',
        ...
        "Terrace waterproofing shall be done in Ghotai using Dr. Fixit LW URP liquid and JK Super cement.",
      ]},
      { title: "GRILL, RAILING, SLIDING WINDOW & DOOR DETAILS", items: [
        ...
        "Ventilators with louvered glass and mosquito net for bathrooms and toilets.",
        "All door frames in typical Steel Gray granite. Different granite selection shall cost extra.",
        "Flush door with both sides laminated for main door and bedroom doors, including Europa lock for all bedroom doors, hinges, fittings etc.",
        "Bathroom door in FRP material including fittings, tadi patti, hinges etc.",
      ]},
      { title: "TILE & GRANITE DETAILS", items: [
        "Toilet / bathroom dado using 300 x 600mm size tile.",
        "Bathroom in anti-skid tile 300 x 300mm.",
        "600 x 600mm tile used for flooring up to the considered rate.",
        ...
        "Staircase riser and tread covered with Steel Gray granite.",
        "For kitchen platform, Z Black granite will be used.",
        'Parking tile of size 16" x 16".',
        "If any selected material is above or below the mentioned rate, the rate difference for material and labour shall be added in billing.",
      ]},
      { title: "PLUMBING DETAILS", items: [
        "All inside lines concealed, outside lines clamped. Pipes used: CPVC, UPVC, PVC (Prince brand).",
        "For bathroom — P-trap commode, flush tank, mixer set, wash basin (Cera / Varmora brand).",
        "External plumbing, chamber making and connection to septic tank / main line chamber.",
      ]},
      { title: "ELECTRICAL DETAILS", items: [
        "All electrical points concealed (25-18mm pipe), Polycab wire, Anchor Roma switch and socket.",
        "Per floor individual main 2.5 sq mm; normal points 1 sq mm; power points 1.5mm wire.",
        "Per room 5 points are given — 1 fan point, 1 light point, 1 AC point, 1 charging point and 1 extra point.",
        "Fittings like lights and fans are provided by client.",
        "Wiring for inverter and the inverter are not included; charged extra as per requirement.",
        "All electrical work considered after electric meter and main wire connection of MSEB by client.",
      ]},
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "BRICKWORK, PLASTER & WATERPROOFING DETAILS", items: [
        'Brick work as per architect drawing, using red brick. Outer wall 9" and all internal walls 6".',
        ...
        "Brickbat waterproofing shall be done in all bathrooms using Dr. Fixit URP.",
        "Terrace waterproofing shall be done in brick bat using Dr. Fixit LW URP liquid and JK Super cement.",
      ]},
      { title: "GRILL, RAILING, SLIDING WINDOW & DOOR DETAILS", items: [
        "Window grill using 10mm bar in typical Bombay design in MS, or as per selection on site.",
        'SS railing for staircase — 2" round pipe, 0.75" pipe and 1.5" pipe, 10mm glass for balcony.',
      ...
      { title: "TILE & GRANITE DETAILS", items: [
        "Toilet / bathroom dado using 1200 x 600mm size tile.",
        "Bathroom and balcony flooring in anti-skid tile 600 x 600mm.",
        "1200 x 1200mm tile used for flooring up to the considered rate.",
        ...
        "Staircase riser and tread covered with Z-black granite.",
        "For kitchen platform, quartz will be used.",
        'Parking tile of size 16" x 16".',
        "If any selected material is above or below the mentioned rate, the rate difference for material and labour shall be added in billing.",
      ]},
      { title: "PLUMBING DETAILS", items: [
      ...
      { title: "ELECTRICAL DETAILS", items: [
        "All electrical points concealed (25-18mm pipe), Polycab wire, Anchor Roma switch and socket.",
        "Per floor individual main 2.5 sq mm; normal points 1 sq mm; power points 1.5mm wire.",
        "All electrical points as per drawing given by architect.",
        "Fittings like lights and fans are in client's scope. Architect to provide position of lights and fans one week before slab.",
        "Wiring for inverter and the inverter are not included; charged extra as per requirement.",
        "All electrical work considered after electric meter and main wire connection of MSEB.",
      ]},
      { title: "POP WORK", items: ["Total house inside POP (Plaster of Paris) for walls, excluding bathrooms and ceilings."] },
      { title: "PAINTING", items: [
