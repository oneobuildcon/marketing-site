    ...
    <main>
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-28 w-full">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              <Link
                href="/contact"
                className="rounded-md bg-amber px-8 py-3 font-semibold text-navy-dark transition hover:bg-amber-light hover:scale-105 transform"
              >
                Get a Free Quote
              </Link>
              <Link
                href="/projects"
                className="rounded-md border border-white/30 px-8 py-3 font-semibold transition hover:bg-white/10"
              >
                View Our Projects →
              </Link>
            </motion.div>
            ...
            {services.map((service) => {
              ...
              return (
                <motion.div
                  ...
                  className="rounded-xl bg-white/5 p-6 border border-white/10 hover:bg-white/10 hover:border-amber/40 transition-colors cursor-default"
                >
          ...
          >
            <motion.div variants={fadeUp}>
              ...
              <p className="mt-3 text-navy/70">
                We combine decades of expertise with modern techniques to deliver
              ...
              {whyChooseUs.map((item) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex items-center gap-3 rounded-xl border border-black/8 p-4 hover:border-amber/40 hover:shadow-md transition-all"
                  >
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <Link href="/projects" className="text-sm font-semibold text-navy hover:text-amber transition-colors">
              View All →
            </Link>
          </motion.div>
          ...
          >
            {testimonials.map((t) => (
              <motion.div
                ...
                variants={fadeUp}
                whileHover={{ y: -4 }}
                className="rounded-2xl bg-white/5 border border-white/10 p-6 text-white hover:border-amber/30 transition-colors"
              >
      ...
      <section className="relative overflow-hidden py-24 text-center text-white">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="mt-3 text-white/80 text-lg">
            Let One O Buildcon bring your vision to life. Free consultation, no obligations.
          </motion.p>
          <motion.div variants={fadeUp}>
            <Link
              href="/contact"
              className="mt-8 inline-block rounded-md bg-amber px-10 py-4 font-semibold text-navy-dark transition hover:bg-amber-light hover:scale-105 transform text-lg"
            >
